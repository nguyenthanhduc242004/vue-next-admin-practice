...
const tableColumnPropsList: TableColumnProps[] = [
    {
        type: 'expand',
        expandHeading: 'Goods Receipt Details: ',
        expandDataUrl: `${BE_URL}/api/goods-receipt-detail`,
...
const formItemPropsList: FormItemProps[] = [
    ...
    },
    {
        ...
        tableFormItemPropsList: [
            {
                ...
                prop: 'ProductID',
                label: 'Product ID',
                placeholder: 'Please select a Product ID',
                autocompleteDataUrl: BE_URL + '/product-data-by-supplier-id',
        ...
        tableFormRules: {
            ...
            ExpiryDate: [
                { required: true, message: 'Please input Expiry Date', trigger: 'change' },
            ],
